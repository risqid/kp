...
class Laporan_model extends CI_Model{
    ...
    function show($tahun){
        ...
        $laporan['total_penjualan'] = $this->db->get_where('pajak_badan', ['tahun' => $tahun])->row_array();
        $this->db->select_sum('pajak');
        $laporan['total_pajak'] = $this->db->get_where('pajak_badan', ['tahun' => $tahun])->row_array();

        // pajak pribadi
        $laporan['pajak_pribadi'] = $this->db->get_where('pajak_pribadi', ['tahun' => $tahun])->result_array();
        $this->db->select_sum('penghasilan');
        $laporan['total_penghasilan'] = $this->db->get_where('pajak_pribadi', ['tahun' => $tahun])->row_array();
        $this->db->select_sum('pajak');
        $laporan['total_pajak_pribadi'] = $this->db->get_where('pajak_pribadi', ['tahun' => $tahun])->row_array();
