                              ...
                              <div class="col-lg-6">
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    ...
                                    <input name="penghasilan" type="text" required autocomplete="off" class="form-control" placeholder="masukkan penghasilan  . . ." onkeyup="calculatePajak(this.value)">
                                  </div>
                                  <small id="penghasilan" class="form-text text-danger"></small>
                                </div>
                              </div>
                              <div class="col-lg-6">
                                <div class="form-group">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="form-button-action">
                              ...
                              <a href="<?= base_url('pajakpribadi/hapus/').$d['id'] ?>" onclick="return confirm('apakah anda yakin ingin menghapusnya?')">
                              ...
                              <div class="col-lg-6">
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    ...
                                    <input name="penghasilan" type="text" required autocomplete="off" class="form-control" placeholder="masukkan penghasilan  . . ." onkeyup="calculateEditPajak(this.value)" on>
                                  </div>
      ...
      <script>
          // form input
          function calculatePajak(penghasilan) {
              var pajak = penghasilan * 0.01;
              document.add.pajak.value = pajak;
              if (isNaN(penghasilan)) {
                  document.getElementById('penghasilan').innerHTML = "masukkan angka!";
              } else {
                  document.getElementById('penghasilan').innerHTML = "";
                  document.getElementById('pajak').innerHTML = "";
              }
          }
          function calculatePenjualan(pajak) {
              var penghasilan = pajak / 0.01;
              document.add.penghasilan.value = penghasilan;
              if (isNaN(pajak)) {
          ...
          function validateForm() {
              ...
              var bulan = document.add.bulan.value;
              var penghasilan = document.add.penghasilan.value;
              var pajak = document.add.pajak.value;
              if (isNaN(tahun) || isNaN(penghasilan) || isNaN(pajak) || bulan == "pilih bulan" ) {
                  return false;
              }
          }
          ...
          function loadEditData(baris) {
              ...
              var penghasilan = baris.getAttribute("data-penghasilan");
              ...
              document.edit.penghasilan.value = penghasilan;
              document.edit.pajak.value = pajak;
          }
          function calculateEditPajak(penghasilan) {
              var pajak = penghasilan * 0.01;
              document.edit.pajak.value = pajak;
              if (isNaN(penghasilan)) {
          ...
          function validateFormEdit() {
              ...
              var bulan = document.edit.bulan.value;
              var penghasilan = document.edit.penghasilan.value;
